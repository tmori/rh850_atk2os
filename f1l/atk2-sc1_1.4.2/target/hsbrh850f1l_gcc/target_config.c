 ...
 *  の責任を負わない．
 *
 *  $Id: target_config.c 107 2014-10-30 09:11:04Z fujisft-shigihara $
 */

/*
 *		ターゲット依存モジュール（HSBRH850F1L用）
 */
...
void
hsbrh850f1l_led_output(uint8 pattern)
{
	uint16 wk;
...
target_clock_initialize(void)
{
	...
	if (SetClockSelection(CKSC_CPUCLKS_CTL, CKSC_CPUCLKS_ACT,
						  PNO_CtrlProt1, 0x03, /* 80MHz f_CPUCLK */
